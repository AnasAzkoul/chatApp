...
exports.updateUserProfile = exports.getUserProfile = exports.logoutUser = exports.registerUser = exports.authUser = exports.getAuthUser = void 0;
...
// access  public
exports.getAuthUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // @ts-ignore
    const { user } = req;
    console.log(user);
...
exports.authUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userExists && isPassword) {
        (0, generateToken_1.default)(res, userExists._id);
        res.status(201).json({
            id: userExists._id,
